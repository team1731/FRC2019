...
import org.usfirst.frc.team1731.robot.paths.RightFeedStationToRocketRearPath;
 ...
 * @see AutoModeBase
 */
public class RightFeedStationToRocketRearMode extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing RightFeedStationToRocketRearMode");
    	
    	PathContainer Path = new RightFeedStationToRocketRearPath();
