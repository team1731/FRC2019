...
import org.usfirst.frc.team1731.robot.paths.RightFeedStationToRocketFrontPath;
 ...
 * @see AutoModeBase
 */
public class RightFeedStationToRocketFrontMode extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing RightFeedStationToRocketFrontMode");
    	
    	PathContainer Path = new RightFeedStationToRocketFrontPath();
