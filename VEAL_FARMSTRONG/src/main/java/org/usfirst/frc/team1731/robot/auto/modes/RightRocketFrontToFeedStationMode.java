...
import org.usfirst.frc.team1731.robot.paths.RightRocketFrontToFeedStationPath;
 ...
 * @see AutoModeBase
 */
public class RightRocketFrontToFeedStationMode extends AutoModeBase {

    @Override
    protected void routine() throws AutoModeEndedException {
    	System.out.println("Executing RightRocketFrontToFeedStationMode");
    	
    	PathContainer Path = new RightRocketFrontToFeedStationPath();
