...
public class RightRocketRearToFeedStationPath implements PathContainer {
    
    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(55,94,0,10));
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(55, 94), Rotation2d.fromDegrees(180.0)); 
    }
